...
* [TSMaster](https://github.com/TOSUN-Shanghai/TSMaster) ⭐ 429 | 🐛 86 | 📅 2026-07-07 - Powerful open environment for automotive CAN and LIN bus monitoring, simulation, testing, diagnostics, calibration and so on *(Closed source)*.
...
1. Also might be useful [this curated list](https://github.com/iDoka/awesome-canbus) ⭐ 3,461 | 🐛 6 | 📅 2026-08-07 of awesome tools and resources for CAN bus reverse engineering with lightly specializing in automotive embedded controller software and communication understanding.
2. The another awesome list [CAN ID collections](https://github.com/iDoka/awesome-automotive-can-id) ⭐ 982 | 🐛 0 | 📅 2026-08-12 also might be useful.
